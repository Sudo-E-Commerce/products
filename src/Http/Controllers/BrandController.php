...
class BrandController extends AdminController
{
	function __construct() {
        $this->models = new \Sudo\Product\Models\Brand;
    ...
    public function index(Request $requests) {
    	$listdata = new ListData($requests, $this->models, 'Product::brands.table', $this->has_locale);
        // Build Form tìm kiếm
    ...
    public function edit($id) {
        ...
        $form->card('col-lg-9');
            ...
            $form->slug('slug', $data_edit->slug, 1, 'Đường dẫn');
